...
//Try comparing surface nets
var bound = surfaceNets.bind(
  undefined,
  cube_edges,
  edge_table,
  buffer,
...
specialize.debug = true
var specialized = specialize(surfaceNets, cube_edges, edge_table, buffer, function(x,y,z) {
    return Math.sqrt(x*x+y*y+z*z) - 1.0;
  }, [[-3,-3,-3], [3,3,3]])

doTest(specialized, "specialize")
